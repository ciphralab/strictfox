...
// Fallback: Explicitly disables browser DoH suitable for System/Network level DNS
user_pref("network.trr.mode", 5);
user_pref("network.proxy.socks_remote_dns", true);
user_pref("network.file.disable_unc_paths", true);
user_pref("network.gio.supported-protocols", "");

/*** [SECTION 0705]: DEFAULT: DNS OVER HTTPS (DoH) ***/
/* Default: Browser-level DNS-over-HTTPS is Enabled below (using Quad9)
 * If you use DNS at the System/Network level (e.g., Pi-hole, router Doh):
 * Comment out this entire section (add // to the start of each line) to prevent conflicts
 */
user_pref("_user.js.parrot", "0705 syntax error: the parrot is using secure DNS!");
user_pref("network.trr.mode", 3);
user_pref("network.trr.uri", "https://dns.quad9.net/dns-query"); // Quad9 (malware/threat blocking)
